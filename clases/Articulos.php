...
<?php//creamos el crud para los articulos primero la imagen 
	class articulos{
		...
		public function insertaArticulo($datos){//insertamos el articulo completo
			$c=new conectar();
			$conexion=$c->conexion();
		...
		public function obtenDatosArticulo($idarticulo){//recuperamos los datos de las tablas articulos segun el ide q pedimos
			$c=new conectar();
			$conexion=$c->conexion();
		...
		public function actualizaArticulo($datos){//modificamos los articulos seleccionados
			$c=new conectar();
			$conexion=$c->conexion();
